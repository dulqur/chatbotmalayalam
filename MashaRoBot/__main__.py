...
PM_START_TEXT = """
`Hellow My name is` *Xandrea*
`iam a lydia ai chat bot to make your group active` 
"""

buttons = [
    [
        InlineKeyboardButton(
            text="add to your group", url="t.me/MashaRoBot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="DEVELOPERS", url="t.me/unitedbotsupport"),
        InlineKeyboardButton(
...
def Masha_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "masha_":
        query.message.edit_text(
            text=""" ℹ️ I'm *xandrea*, a telegram chat bot to make your group active.
              
              ★the bot was developed by united bots 
              ★add to your group the bot talks malayalam hindi tamil english langs 
              
              ★MORE ON XANDREA
               ★bot can play songs in your group voice chat
               ★Bot uses multi languages to chat
               ★download songs using this bot
               ★translator and tts / stt 
                

               FOR ANY QUESTIONS ASK @unitedbotsupport
              .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..I'm *xandrea*
                 \nHere is the support group ask question @unitedbotsupport .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
